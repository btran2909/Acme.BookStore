...
const routes: Routes = [
  ...
  { path: 'authors', loadChildren: () => import('./authors/author/author.module').then(m => m.AuthorModule) },
  { path: 'books', loadChildren: () => import('./books/book/book.module').then(m => m.BookModule) },
];
