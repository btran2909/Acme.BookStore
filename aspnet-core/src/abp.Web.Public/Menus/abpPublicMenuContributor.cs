...
namespace abp.Web.Public.Menus
{
    public class abpPublicMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public abpPublicMenuContributor(IConfiguration configuration)
        {
