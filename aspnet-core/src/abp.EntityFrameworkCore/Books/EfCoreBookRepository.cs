...
namespace abp.Books
{
    public class EfCoreBookRepository : EfCoreRepository<abpDbContext, Book, Guid>, IBookRepository
    {
        public EfCoreBookRepository(IDbContextProvider<abpDbContext> dbContextProvider)
