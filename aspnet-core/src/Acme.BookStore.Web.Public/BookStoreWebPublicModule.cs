...
using Acme.BookStore.Web.Public.Menus;
...
namespace Acme.BookStore.Web.Public
{
    ...
    public class BookStoreWebPublicModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    ...
                    typeof(BookStoreWebPublicModule).Assembly
                );
            });
        }
        ...
        private void ConfigureAutoMapper()
        {
            ...
            {
                options.AddMaps<BookStoreWebPublicModule>();
            });
        }
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            ...
            {
                options.FileSets.AddEmbedded<BookStoreWebPublicModule>();
                ...
                if (hostingEnvironment.IsDevelopment())
                {
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<BookStoreWebPublicModule>(hostingEnvironment.ContentRootPath);
                }
            });
        }
        ...
        private void ConfigureNavigationServices(IConfiguration configuration)
        {
            ...
            {
                options.MenuContributors.Add(new BookStorePublicMenuContributor(configuration));
            });
